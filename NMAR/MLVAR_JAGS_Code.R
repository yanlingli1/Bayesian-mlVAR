...
jagsModel <- jags.model(file = "mlvar_9dim.txt", data = jags_data, inits=list(inits1,inits2), n.chains = 2, n.adapt = 4000) #n.adapt = 4000
update(jagsModel, n.iter = 1000) 


parameterlist <-c("CoeffInter","CoeffAR","CoefflogSD_VAR","Coeffcorr_VAR",
                  "sigmaInter","sigmaAR","logS_SD","R_SD","bcov","lambda",
